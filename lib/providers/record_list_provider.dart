...
final recordListProvider = ChangeNotifierProvider((ref) => RecordList());

class RecordList extends ChangeNotifier {
  List<Record>? records;

  fetchRecordList(String birdId, DateTime startDate, DateTime endDate) async {
